        ...
        <form class="needs-validation" novalidate>
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="address" placeholder="" name="alamat" required>
                ...
                <div class="col-md-5">
                    <label for="country" class="form-label">Jenis Bahan</label>
                    <select class="form-select" id="jenisBahan" name="jenisBahan" required>
                        <?php
                        $ambilBahan = $conn->query("SELECT * FROM data_bahanBaju");
                        while ($pecahBahan = $ambilBahan->fetch_assoc()) :

                        ?>
                            <option value="<?= $pecahBahan['jenis_bahan'] ?>"><?php echo $pecahBahan['jenis_bahan']; ?></option>
                        <?php
                        endwhile;
                ...
                <div class="col-md-4">
                    <label for="address" class="form-label">jenis sablon</label>
                    <input type="text" class="form-control" id="jenisSablon" name="JenisSablon" placeholder="<?= $pecah['jenis_sablon'] ?>" value="<?= $pecah['jenis_sablon'] ?>" required>
                </div>

                <div class="col-md-3">
                    <label for="zip" class="form-label">Kirim desain mu</label>
                    <input type="file" class="form-control" id="desain" name="desain" placeholder="" required>
            ...
            <div class="col-12">
                ...
                <input type="text" class="form-control" id="deskripsi" placeholder="" name="deskripsi" required>
